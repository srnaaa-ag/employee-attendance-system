...
export default function LeaveRequests() {
    ...
    // const [pendingLoadError, setPendingLoadError] = useState(/** @type {string | null} */ (null));
    // const [reviewNotes, setReviewNotes] = useState(/** @type {Record<string, string>} */ ({}));
    const admin = isAdmin();
    ...
    //         setPendingList([]);
    //         if (err instanceof Error && err.message === "NEMA_PRISTAP_ADMIN_LISTA") {
    //             setPendingLoadError(
    //                 "Не можам да ја вчитам листата: backend не те признава како администратор. Најави се со админ сметка за да ги видиш барањата на чекање.",
    //             );
    //         } else {
    //             setPendingLoadError("Не можам да ја вчитам листата. Провери дали Spring backend работи на порт 8080.");
    //         }
    //     }
    // }, [admin]);
                ...
                <div className="card">
                    ...
                    <div className="row">
                        <div>
                            ...
                            <input type="date" name="startDate" value={form.startDate} onChange={handleChange}/></div>
                        <div>
                            <label>До датум</label>
                            <input type="date" name="endDate" value={form.endDate} onChange={handleChange}/></div>
                    </div>
                ...
                <div className="card leave-admin-card leave-admin-card--demo">
                    ...
                    />
                                ...
                                <td className="leave-admin-actions">
                                    <button type="button" className="primary-btn leave-btn-approve" disabled
                                            title="Демо">
                                        Одобри
                                    </button>
                                    <button type="button" className="secondary-btn leave-btn-reject" disabled
                                            title="Демо">
                                        Одбиј
                                    </button>
                                </td>
